...
- **OpenAI image generation** — adapted portrait artwork and refined metallic icons. The Game Plan prompt set is retained in the repository at `artwork/prompts-game-plan.md`.
- **FFmpeg and CriCodecs** — intro conversion tools; they are not bundled with this release. [CriCodecs](https://github.com/Youjose/CriCodecs)

Game assets, club/competition marks and third-party components retain their respective ownership and terms. This project does not grant a blanket license over those materials and is not an official Konami or SmokePatch release. Preserve these credits when sharing this package.
